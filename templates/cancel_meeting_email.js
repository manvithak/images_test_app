...
exports.generate_cancel_template = (meeting) => {
        ...
        <tr>
            <td style="padding: 0 64px 0 64px;">
                ...
                <p style="
                    ...
                    line-height: 1.5;
                ">
                    ${meeting.organizer_name} has an upcoming meeting with you at ${meeting.start_time}, ${meeting.timezone} <a href="${meeting.meeting_url}"
